...
return [
    ...
    // 首页更多分类
    'HOME_COMMERCE_ACADEMY' => 'ビジネススクール',
    'HOME_MORE' => 'もっと',
    'HOME_TRANSFER' => '転送',
    'HOME_MINING_POOL' => 'マイニングプール',
    'HOME_SUBSCRIBE' => '申し込む',
    'HOME_LEDGER' => '元帳',
    'HOME_INVITATION_TO_ACTIVATE' => 'アクティベートへの招待',
    'HOME_BLOCK_QUERY' => 'クエリをブロックする',
    'HOME_DAFI' => 'DaFi',
    'HOME_RED_ENVELOPE' => '赤い封筒',
    'HOME_CONVERT' => '両替',
    'HOME_MALL' => 'モール',
    'HOME_CULTURE' => '文化',
    'HOME_TOURISM' => '観光',
    'HOME_CIRCLE_INFORMATION' => 'サークル情報',
    'HOME_COMMUNITY' => 'コミュニティ',
    'HOME_MINING_MACHINE' => 'マイニングマシン',

    'PAYEE_ERROR' => '受取人エラー',
    'QUANTITY_MUST_BE_A_NUMBER' => '数量は数値でなければなりません',
    'PLEASE_ACTIVATE_YOURSELF_FIRST' => '最初に自分自身をアクティブにしてください',
    'THE_ACTIVE_USER_DOES_NOT_EXIST' => 'アクティブなユーザーは存在しません',
    'USER_HAS_BEEN_ACTIVATED' => 'ユーザーがアクティブ化されました',

    'YOU_HAVE_BEEN_FROZEN_AND_CANNOT_TRADE' => 'あなたは凍結されており、取引することはできません',
    'YOU_HAVE_NOT_ACTIVATED_YET_AND_CANNOT_TRADE' => 'まだアクティベートしておらず、取引できません',
    'NOT_YET_OPEN' => 'まだ開いていません',
    'SYSTEM_ERROR' => 'システムエラー',
    'PLEASE_ENTER_THE_CORRECT_PRICE' => '正しい価格を入力してください',
    'USER_DOES_NOT_EXIST' => 'ユーザーは存在しません',

    // 兑换
    'SORRY_THE_EXCHANGE_IS_NOT_YET_OPEN' => '申し訳ありませんが、取引所はまだ開いていません',
    'FAILED_TO_GET_WALLET' => 'ウォレットを取得できませんでした',
    'FAILED_TO_GET_MARKET_INFORMATION' => '市場情報を取得できませんでした。しばらくしてからもう一度お試しください',
    'DO_NOT_REPEAT_REQUEST' => 'リクエストを繰り返さないでください',
    'WALLET_UNAVAILABLE' => 'ウォレットは利用できません',
    'INSUFFICIENT_AVAILABLE_BALANCE' => '利用可能なバランスが不十分',
    'THE_FEE_WALLET_IS_NOT_AVAILABLE' => '料金ウォレットはご利用いただけません',
    'INSUFFICIENT_HANDLING_FEE' => '手数料が足りない',
    'MINIMUM_EXCHANGE_AMOUNT' => '{:name}最小交換額は：{:min_quantity}',
    ...
    'TRANSFER_IN' => '転送',
    'TRANSFER_FEE' => '転送料',
    'CURRENCY_TRANSFER' => '通貨取引',
    'CANCELLATION_OF_CURRENCY_TRANSACTIONS' => '通貨取引のキャンセル',
    'EXCHANGE' => '両替',
    'EXCHANGE_FEE' => '交換手数料',
    'WITHDRAW' => '撤退',
    'WITHDRAW_FEE' => '引き出し手数料',
    'WITHDRAWAL_FAILURE_REFUND' => '引き出し失敗の払い戻し',
    'BACKGROUND_MODIFICATION' => '背景の変更',
    'MODIFY_THE_BALANCE_IN_THE_BACKGROUND' => 'バックグラウンドでバランスを変更します',
    'MODIFY_THE_FROZEN_AMOUNT_IN_THE_BACKGROUND' => 'バックグラウンドで凍結量を変更する',
    'BUY_MINING_MACHINE' => 'マイニングマシンを購入する',
    'REWARD_STRAIGHT' => '収益を共有する',
    'REWARD_INDIRECT' => '収益を共有する',
    'REWARD_DIFFERENTIAL' => 'チームのメリット',
    'UPGRADE_MINING_MACHINE' => 'マイナーをアップグレードする',
    'REWARD_SAME_LEVEL' => '平等な収入',

    'THE_WALLET_ACCOUNT_IS_NOT_ACTIVATED_AND_CANNOT_BE_PURCHASED' => 'ウォレットアカウントが有効化されておらず、購入できません',
    'PLEASE_ACTIVATE_YOUR_ACCOUNT_FIRST' => '最初にアカウントをアクティブ化してください',
];
