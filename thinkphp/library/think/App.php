...
class App extends Container
{
    ...
    public function initialize()
    {
        ...
        $this->runtimePath = $this->rootPath . 'runtime/' . $this->appVersions . '/' . DIRECTORY_SEPARATOR;
        $this->routePath   = $this->rootPath . 'route' . DIRECTORY_SEPARATOR;
        $this->configPath  = $this->rootPath . 'application/api/' . $this->appVersions . '/config' . DIRECTORY_SEPARATOR;
    ...
    public function routeInit()
    {
       // 路由检测
        if (is_dir($this->routePath)) {
            ...
            $filename = $this->rootPath . 'application/api/' . $this->appVersions . '/config/router.php';
            // dump($filename);exit;
            $files = glob($filename);
